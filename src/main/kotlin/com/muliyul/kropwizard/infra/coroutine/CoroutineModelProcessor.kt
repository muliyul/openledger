...
class CoroutineModelProcessor @Inject constructor(
	...
	/**
	 * Go through every child resource in the resourceModel and replace any coroutine resource methods found
	 */
	...
	/**
	 * Go through every child resource in the subResourceModel and replace any coroutine resource methods found
	 */
